...
{  
    ...
    if  (ww==0)  ww="SUN \r Good luck";  
    if  (ww==1)  ww="MON \r vx:83905029";  
    if  (ww==2)  ww="TUE \r vx:83905029";  
    if  (ww==3)  ww="WED \r vx:83905029";  
    if  (ww==4)  ww="THU \r vx:83905029";  
    if  (ww==5)  ww="FRI \r vx:83905029";  
    if  (ww==6)  ww="SAT \r Nice day";  
    colorfoot="</font>"  
    if (useAm == 0) {
